...
from DisplayPattern import nTimesCapAlphabetInOneRow
...
def main():
    ...
    try:
        ...
        print("Used to display n'th times cap alphabets in single row")
        iValue  = int(input("Please enter number: "))

        # calling to user defined nTimesCapAlphabetInOneRow
        # method from DisplayPattern module
        nTimesCapAlphabetInOneRow(iValue)   
