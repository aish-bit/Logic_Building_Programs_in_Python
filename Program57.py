...
from DisplayPattern import displayNTimesSmallAlphabetInSingleCol
...
def main():
    ...
    try:
        ...
        print("Used to display n'th times small alphabets in single column")
        iValue  = int(input("Please enter number: "))

        # calling to user defined displayNTimesSmallAlphabetInSingleCol
        # method from DisplayPattern module
        displayNTimesSmallAlphabetInSingleCol(iValue)   
