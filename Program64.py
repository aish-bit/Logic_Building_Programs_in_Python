...
from DisplayPattern import dollarDiagonalStarSq
...
def main():
    ...
    try:
        ...
        print("Used to display dollar diagonal star Square pattern on console")
        iRow  = int(input("Please enter row required: "))
        iCol  = int(input("Please enter col required: "))

        # calling to user defined dollarDiagonalStarSq method 
        # user defined DisplayPattern module
        dollarDiagonalStarSq(iRow,iCol)   
