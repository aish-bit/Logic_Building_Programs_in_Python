...
from DisplayPattern import hashStarOneByOneRowBox
...
def main():
    ...
    try:
        ...
        print("Used to display hash-star-OneByOneRow-Box pattern on console")
        iRow  = int(input("Please enter row required: "))
        iCol  = int(input("Please enter col required: "))

        # calling to user defined hashStarOneByOneRowBox method 
        # user defined DisplayPattern module
        hashStarOneByOneRowBox(iRow,iCol)   
