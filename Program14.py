###############################################################################
# Q : 
# Accept no from user and display all positive integers 
# upto that no on console
# Input  : -5   or   5
# Output:  1 2 3 4 5
...
from ProblemOnNumber import displayUptoNPositiveInt
...
def main():
    ...
    try:
        ...
        # calling to user defined displayUptoNPositiveInt() method
        # from ProblemOnNumber module
        displayUptoNPositiveInt(iValue)
