###############################################################################
# Q : 
# Accept no from user and display all positive integers upto that n number on console
# in reverse.
# Input:5
# Output:5 4 3 2 1
# Input:-5
...
from ProblemOnNumber import displayUptoNPositiveIntRev
...
def main():
    ...
    try:
        ...
        # calling to user defined displayUptoNPositiveIntRev method
        # from ProblemOnNumber module
        displayUptoNPositiveIntRev(iValue)
